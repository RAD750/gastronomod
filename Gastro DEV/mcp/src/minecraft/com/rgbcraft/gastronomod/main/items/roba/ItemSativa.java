	...
	public ItemStack onFoodEaten(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		...
		if (!par2World.isRemote) {
			...
			if (chance < 10) {
				...
				par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, 1800, 3));
				...
				par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.jump.id, 800, 0));
			}
