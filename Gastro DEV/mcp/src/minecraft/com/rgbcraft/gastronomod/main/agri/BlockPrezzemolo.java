...
public class BlockPrezzemolo extends BlockCrops {

    protected BlockPrezzemolo(int id, int textId) {
        super(id, textId);
    ...
    protected int getSeedItem() {
        return Items.prezzemoloSemi.itemID;
    }

    protected int getCropItem() {
        return Items.prezzemolo.itemID;
    }
}